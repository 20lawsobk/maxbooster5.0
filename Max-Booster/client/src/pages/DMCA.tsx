    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50">
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="mb-8">
            <CardContent className="p-8">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900">Copyright Infringement Policy</h2>
              </div>
          ...
          <Card className="mb-8">
            <CardContent className="p-8">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900">Filing a DMCA Notice</h2>
              </div>
              <div className="space-y-4 text-gray-700">
                <p>
          ...
          <Card className="mb-8">
            <CardContent className="p-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Contact for DMCA Notices</h2>
