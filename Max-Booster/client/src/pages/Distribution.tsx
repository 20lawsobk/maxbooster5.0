                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">
                        {analyticsGrowth?.streamsGrowth
                          ? `${analyticsGrowth.streamsGrowth >= 0 ? '+' : ''}${analyticsGrowth.streamsGrowth.toFixed(1)}% vs last month`
                          : 'No change'}
                      </p>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-green-600 dark:text-green-400 mt-1">
                        {analyticsGrowth?.earningsGrowth
                          ? `${analyticsGrowth.earningsGrowth >= 0 ? '+' : ''}${analyticsGrowth.earningsGrowth.toFixed(1)}% vs last month`
                          : 'No change'}
                      </p>
                    </div>
