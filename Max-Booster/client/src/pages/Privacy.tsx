        ...
        <Card>
          <CardContent className="p-8 prose dark:prose-invert max-w-none">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              <div className="flex items-start space-x-3 p-4 bg-green-50 dark:bg-green-950/20 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-300">Your data is encrypted at rest and in transit</p>
                </div>
              </div>
              <div className="flex items-start space-x-3 p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-300">Full transparency about what's collected and why</p>
                </div>
              </div>
              <div className="flex items-start space-x-3 p-4 bg-purple-50 dark:bg-purple-950/20 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-300">Your personal data is never sold</p>
                </div>
              </div>
            </div>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">When you register and use Max Booster's services, the following is collected:</p>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li><strong>Streaming Platforms:</strong> When you distribute your music</li>
              </ul>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">Industry-standard security measures are implemented to protect your data:</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300">Request a copy of your personal data in a portable format</p>
                  </div>
                </div>
            ...
            <section className="mb-8">
              ...
              <ul className="list-none space-y-2">
                <li><strong>Email:</strong> privacy@maxbooster.ai</li>
                <li><strong>Support:</strong> support@maxbooster.ai</li>
