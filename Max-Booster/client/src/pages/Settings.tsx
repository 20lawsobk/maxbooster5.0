              ...
              <div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Select value={preferences.theme} onValueChange={(value) => handlePreferenceChange("theme", value)}>
                    ...
                    <SelectContent>
                      <SelectItem value="dark" data-testid="select-theme-dark">Dark</SelectItem>
                      <SelectItem value="light" data-testid="select-theme-light">Light</SelectItem>
                      <SelectItem value="system" data-testid="select-theme-system">System</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Select value={preferences.defaultKey} onValueChange={(value) => handlePreferenceChange("defaultKey", value)}>
                      ...
                      <SelectContent>
                        <SelectItem value="C" data-testid="select-key-c">C Major</SelectItem>
                        <SelectItem value="G" data-testid="select-key-g">G Major</SelectItem>
                        <SelectItem value="D" data-testid="select-key-d">D Major</SelectItem>
                        <SelectItem value="A" data-testid="select-key-a">A Major</SelectItem>
                        <SelectItem value="E" data-testid="select-key-e">E Major</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-medium">
                          {paymentMethod?.last4 ? `•••• •••• •••• ${paymentMethod.last4}` : 'No payment method'}
                        </p>
                        <p className="text-sm text-muted-foreground">
                          {paymentMethod?.expiry ? `Expires ${paymentMethod.expiry}` : 'Add payment method'}
                        </p>
                      </div>
                    </div>
                    <Button 
                ...
                {billingLoading ? (
                  ...
                  <div className="space-y-3">
                    {billingHistory.map((billing: any) => (
                      <div key={billing.id || billing.invoiceId} className="flex items-center justify-between p-3 bg-muted/20 rounded" data-testid={`billing-${billing.invoiceId}`}>
                        <div>
                ...
                {sessionsLoading ? (
                  ...
                  <div className="space-y-3">
                    {loginSessions.map((session: any) => (
                      <div key={session.id} className="flex items-center justify-between p-3 bg-muted/20 rounded" data-testid={`session-${session.id}`}>
                        <div>
      ...
      <AlertDialog open={cancelSubscriptionOpen} onOpenChange={setCancelSubscriptionOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to cancel your subscription? You'll continue to have access to Max Booster Pro features until the end of your current billing period.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
