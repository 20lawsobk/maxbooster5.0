                ...
                <div className="flex items-center justify-between p-4 bg-accent/10 rounded-lg border border-accent/20">
                  ...
                  <div className="flex space-x-2">
                    <Button
                      ...
                      size="sm"
                      onClick={() => {
                        // Open scheduling dialog or navigate to scheduling page
                        toast({
                          title: "Schedule for Later",
                          description: "Opening scheduling interface...",
                        });
                        // TODO: Implement scheduling modal or navigation to scheduling page
                        // Could be: setShowScheduleDialog(true) or navigate('/social-media?schedule=true')
                      }}
