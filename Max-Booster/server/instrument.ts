...
Sentry.init({
  dsn: process.env.NODE_ENV === 'production' 
    ? (process.env.SENTRY_DSN || "https://160f9a7fe10a384154f5087b2139b2ee@o4510378512613376.ingest.us.sentry.io/4510378520936448")
...
if (process.env.NODE_ENV === 'production') {
  console.log('✅ Sentry error tracking initialized (production mode)');
} else {
  console.log('✅ Sentry instrumentation loaded (development mode - no data sent)');
}
