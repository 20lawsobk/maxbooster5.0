import {
  ...
  distributionTracks,
  studioConversions,
  studioCollabSessions,
  studioCollabSnapshots,
  projectCollaborators,
  projectRoyaltySplits,
  revenueEvents,
  royaltyLedger,
  royaltyPayments,
  collaboratorTaxProfiles,
  revenueImportHistory,
  forecastSnapshots,
  trendEvents,
  modelVersions,
  optimizationTasks,
  ...
  type InsertTrack,
  type TrackAnalysis,
  type InsertTrackAnalysis,
  type StudioProject,
  type InsertStudioProject,
  type StudioTrack,
  type InsertStudioTrack,
  type AudioClip,
  type InsertAudioClip,
  type MidiClip,
  type InsertMidiClip,
  type VirtualInstrument,
  type InsertVirtualInstrument,
  type AudioEffect,
  type InsertAudioEffect,
  type MixBus,
  type InsertMixBus,
  type AutomationData,
  type InsertAutomationData,
  type Marker,
  type InsertMarker,
  type Lyrics,
  type InsertLyrics,
  type GeneratedMelody,
  ...
  type InsertGeneratedMelody,
  type SocialInfluencerScore,
  type InsertSocialInfluencerScore,
  type SocialViralTracking,
  type InsertSocialViralTracking,
  type SocialNetworkAnalysis,
  type InsertSocialNetworkAnalysis,
  type AdCampaign,
  type InsertAdCampaign,
  type AdInsights,
  type InsertAdInsights,
  type AdCreative,
  type InsertAdCreative,
  type AdCompetitorIntelligence,
  type InsertAdCompetitorIntelligence,
  type AdAudienceSegment,
  type InsertAdAudienceSegment,
  type AdCreativePrediction,
  type InsertAdCreativePrediction,
  type AdConversion,
  type InsertAdConversion,
  type AdAIRun,
  type InsertAdAIRun,
  type AdCampaignVariant,
  type DistroRelease,
  type InsertDistroRelease,
  type DistroTrack,
  type InsertDistroTrack,
  type InsertAdCampaignVariant,
  type AdPlatformAccount,
  type InsertAdPlatformAccount,
  type AdDeliveryLog,
  type InsertAdDeliveryLog,
  type AdKillRule,
  type InsertAdKillRule,
  type AdRuleExecution,
  type InsertAdRuleExecution,
  type Payout,
  type InsertPayout,
  type Listing,
  type Order,
  ...
  type InsertDistributionPackage,
  type DistributionTrack,
  type InsertDistributionTrack,
  type StudioCollabSession,
  type InsertStudioCollabSession,
  type StudioCollabSnapshot,
  type InsertStudioCollabSnapshot,
  type ProjectCollaborator,
  type InsertProjectCollaborator,
  type ProjectRoyaltySplit,
  type InsertProjectRoyaltySplit,
  type RevenueEvent,
  type InsertRevenueEvent,
  type RoyaltyLedger,
  type InsertRoyaltyLedger,
  type RoyaltyPayment,
  type InsertRoyaltyPayment,
  type CollaboratorTaxProfile,
  type InsertCollaboratorTaxProfile,
  type RevenueImportHistory,
  type InsertRevenueImportHistory,
  type ForecastSnapshot,
  type InsertForecastSnapshot,
  type TrendEvent,
  ...
  type PayoutSettings,
  type InsertPayoutSettings,
  type PaymentMethod,
  type InsertPaymentMethod,
  type UploadSession,
  type InsertUploadSession,
  type ISRCRegistry,
  type InsertISRCRegistry,
  type UPCRegistry,
  type InsertUPCRegistry,
  type JWTToken,
  type InsertJWTToken,
  type RefreshToken,
  type InsertRefreshToken,
  type TokenRevocation,
  type InsertTokenRevocation,
  type Permission,
  type InsertPermission,
  type WebhookAttempt,
  type InsertWebhookAttempt,
  type WebhookDeadLetterQueue,
  type InsertWebhookDeadLetterQueue,
  type LogEvent,
  type InsertLogEvent,
  type RoyaltySplit,
  aiModels,
  ...
  type AICanaryDeployment,
  type InsertAICanaryDeployment,
  type AIRetrainingSchedule,
  type InsertAIRetrainingSchedule,
  type AIRetrainingRun,
  type InsertAIRetrainingRun,
  type AIDeploymentHistory,
  type InsertAIDeploymentHistory,
  type InsertRoyaltySplit,
  type UserAsset,
...
export interface IStorage {
  ...
  getUserProjectsWithStudio(
    userId: string,
    options?: PaginationOptions & { studioOnly?: boolean }
  ...
  ): Promise<PaginatedResponse<AnalyticsAnomaly>>;
  ...
  getAnomalySummary(
    userId: string
  ): Promise<{ total: number; bySeverity: Record<string, number>; unacknowledged: number }>;
  ...
  updateNotificationPreferences(userId: string, preferences: unknown): Promise<void>;
  updatePushSubscription(userId: string, subscription: unknown): Promise<void>;
  ...
  createHyperFollowPage(data: unknown): Promise<any>;
  ...
  updateHyperFollowPage(id: string, data: unknown): Promise<any>;
  deleteHyperFollowPage(id: string): Promise<void>;
  trackHyperFollowEvent(slug: string, eventType: string, data?: unknown): Promise<void>;
  ...
  createDistroProvider(provider: unknown): Promise<any>;
  getDistroDispatch(id: string): Promise<any | undefined>;
  createDistroDispatch(dispatch: unknown): Promise<any>;
  updateDistroDispatch(id: string, updates: unknown): Promise<any>;
  ...
  updateStudioTrackEffects(id: string, projectId: string, effects: unknown): Promise<StudioTrack>;
  ...
  getProcessedTrackAudio(
    trackId: string
  ): Promise<{ filePath: string; processingInfo: any } | null>;
  ...
  updateVirtualInstrument(
    id: string,
    trackId: string,
    updates: Partial<VirtualInstrument>
  ): Promise<VirtualInstrument>;
  ...
  updateDistributionTrack(
    id: string,
    packageId: string,
    updates: Partial<DistributionTrack>
  ...
  // ISRC operations
  generateISRC(userId: string, trackId: string, metadata: unknown): Promise<string>;
  getISRC(code: string): Promise<ISRCRegistry | undefined>;
  verifyISRCUniqueness(code: string): Promise<boolean>;

  // UPC operations
  generateUPC(userId: string, releaseId: string, metadata: unknown): Promise<string>;
  ...
  createConversion(conversion: unknown): Promise<any>;
  ...
  saveOrganicMetrics(campaignId: number, organicMetrics: unknown): Promise<void>;
  ...
  updateAdCampaignVariant(
    id: string,
    updates: Partial<InsertAdCampaignVariant>
  ): Promise<AdCampaignVariant>;
  ...
  updateAdInsights(
    id: string,
    userId: string,
    updates: Partial<InsertAdInsights>
  ): Promise<AdInsights>;
  ...
  getListings(filters?: unknown): Promise<Listing[]>;
  getListing(id: string): Promise<Listing | undefined>;
  getUserListings(userId: string): Promise<Listing[]>;
  createListing(listing: unknown): Promise<Listing>;
  ...
  // Marketplace Orders
  getOrders(filters?: unknown): Promise<Order[]>;
  getOrder(id: string): Promise<Order | undefined>;
  getUserOrders(userId: string): Promise<Order[]>;
  getSellerOrders(userId: string): Promise<Order[]>;
  createOrder(order: unknown): Promise<Order>;
  ...
  getRoyaltyStatements(userId: string, filters: unknown): Promise<any[]>;
  ...
  getUserPayouts(userId: string, options: unknown): Promise<any[]>;
  ...
  getUserEarnings(userId: string, options: unknown): Promise<any[]>;
  ...
  createPayout(data: unknown): Promise<any>;
  ...
  updatePayoutSettings(
    userId: string,
    data: Partial<InsertPayoutSettings>
  ): Promise<PayoutSettings>;
  updateTaxInfo(
    userId: string,
    data: { taxCountry: string; taxId: string; taxFormCompleted?: boolean }
  ): Promise<PayoutSettings>;
  ...
  updateProjectRoyaltySplit(
    id: string,
    data: Partial<InsertProjectRoyaltySplit>
  ): Promise<ProjectRoyaltySplit>;
  ...
  getPendingEarningsForCollaborator(
    collaboratorId: string
  ): Promise<{ total: string; byProject: unknown[] }>;
  getTotalEarningsForCollaborator(
    collaboratorId: string
  ): Promise<{ total: string; paid: string; pending: string }>;
  ...
  getProjectRoyaltySummary(
    projectId: string
  ): Promise<{ collaborators: unknown[]; totalRevenue: string; splits: unknown[] }>;

  // Sales operations - userId is varchar (string), beatId is serial (number)
  getUserSales(userId: string, options: unknown): Promise<any[]>;
  ...
  updateAdminSetting(key: string, value: unknown): Promise<void>;
  ...
  getPluginCatalog(category?: string): Promise<
    Array<{
      id: string;
      slug: string;
      name: string;
  ...
  createProjectCollaborator(data: unknown): Promise<any>;
  updateProjectCollaborator(id: string, updates: unknown): Promise<any>;
  ...
  createCollabSession(session: unknown): Promise<any>;
  getActiveCollabSessions(projectId: string): Promise<any[]>;
  updateCollabSessionActivity(id: string, awarenessState: unknown): Promise<void>;
  ...
  saveCollabSnapshot(snapshot: unknown): Promise<any>;
  ...
  createTaxProfile(profile: unknown): Promise<any>;
  ...
  createImportHistory(importData: unknown): Promise<any>;
  getImportHistory(userId: string): Promise<any[]>;
  checkFileHash(hash: string): Promise<any | undefined>;
  ingestRevenueBatch(events: unknown[]): Promise<{ succeeded: number; failed: number }>;
  ...
  createForecast(forecast: unknown): Promise<any>;
  ...
  listComplianceControls(filters?: {
    standard?: string;
    status?: string;
    category?: string;
  ...
  listComplianceEvidence(filters?: {
    controlId?: string;
    evidenceType?: string;
    automated?: boolean;
...
export class DatabaseStorage implements IStorage {
  ...
  async getUserProjectsWithStudio(
    userId: string,
    options: PaginationOptions & { studioOnly?: boolean } = {}
  ): Promise<PaginatedResponse<Project>> {
    return this.executeWithCircuitBreaker(async () => {
  ...
  async getAllProjects(options: PaginationOptions = {}): Promise<PaginatedResponse<Project>> {
    return this.executeWithCircuitBreaker(async () => {
      ...
      const [totalCount] = await db.select({ count: sql<number>`count(*)` }).from(projects);
  ...
  async acknowledgeAnomaly(id: string, userId: string): Promise<AnalyticsAnomaly> {
    return this.executeWithCircuitBreaker(async () => {
      const [anomaly] = await db
        .update(analyticsAnomalies)
        .set({ acknowledgedAt: new Date() })
        .where(and(eq(analyticsAnomalies.id, id), eq(analyticsAnomalies.userId, userId)))
        .returning();
      return anomaly;
    }, 'acknowledgeAnomaly');
  }
  ...
  async updateNotificationPreferences(userId: string, preferences: unknown): Promise<void> {
    return this.executeWithCircuitBreaker(async () => {
      await db
        .update(users)
  ...
  async updatePushSubscription(userId: string, subscription: unknown): Promise<void> {
    return this.executeWithCircuitBreaker(async () => {
  ...
  async getReleaseEarnings(releaseId: string, userId: string): Promise<any[]> {
    return this.executeWithCircuitBreaker(async () => {
      return await db
        ...
        .where(and(eq(earnings.releaseId, releaseId), eq(releases.userId, userId)))
        .orderBy(desc(earnings.reportDate));
    }, 'getReleaseEarnings');
  }

  async createHyperFollowPage(data: unknown): Promise<any> {
    return this.executeWithCircuitBreaker(async () => {
      const [page] = await db.insert(hyperFollowPages).values(data).returning();
      return page;
  ...
  async getHyperFollowPage(id: string): Promise<any | undefined> {
    return this.executeWithCircuitBreaker(async () => {
      const [page] = await db.select().from(hyperFollowPages).where(eq(hyperFollowPages.id, id));
      return page;
    }, 'getHyperFollowPage');
  }
  ...
  async updateHyperFollowPage(id: string, data: unknown): Promise<any> {
    return this.executeWithCircuitBreaker(async () => {
  ...
  async trackHyperFollowEvent(slug: string, eventType: string, data?: unknown): Promise<void> {
    return this.executeWithCircuitBreaker(async () => {
      ...
      if (eventType === 'pageView') {
        ...
        analytics.platformClicks[data.platform] =
          (analytics.platformClicks[data.platform] || 0) + 1;
      }
  ...
  async getDistroProvider(id: string): Promise<any | undefined> {
    return this.executeWithCircuitBreaker(async () => {
      const [provider] = await db.select().from(distroProviders).where(eq(distroProviders.id, id));
      return provider;
    }, 'getDistroProvider');
  }
  ...
  async createDistroProvider(provider: unknown): Promise<any> {
    return this.executeWithCircuitBreaker(async () => {
      const [newProvider] = await db.insert(distroProviders).values(provider).returning();
      return newProvider;
  ...
  async getDistroDispatch(id: string): Promise<any | undefined> {
    return this.executeWithCircuitBreaker(async () => {
      const [dispatch] = await db.select().from(distroDispatch).where(eq(distroDispatch.id, id));
      return dispatch;
    }, 'getDistroDispatch');
  }

  async createDistroDispatch(dispatch: unknown): Promise<any> {
    return this.executeWithCircuitBreaker(async () => {
      const [newDispatch] = await db.insert(distroDispatch).values(dispatch).returning();
      return newDispatch;
    }, 'createDistroDispatch');
  }

  async updateDistroDispatch(id: string, updates: unknown): Promise<any> {
    return this.executeWithCircuitBreaker(async () => {
    ...
    return this.executeWithCircuitBreaker(async () => {
      if (slug) {
        const [provider] = await db
          .select()
          .from(distroProviders)
          .where(and(eq(distroProviders.slug, slug), eq(distroProviders.status, 'active')))
          .limit(1);
  ...
  async upsertDistributionProvider(data: unknown): Promise<any> {
    return this.executeWithCircuitBreaker(async () => {
      ...
      const [created] = await db.insert(distroProviders).values(data).returning();
      return created;
  ...
  async createStudioTrack(track: InsertStudioTrack): Promise<StudioTrack> {
    return this.executeWithCircuitBreaker(async () => {
      const [newTrack] = await db.insert(studioTracks).values(track).returning();
      return newTrack;
    }, 'createStudioTrack');
  }

  async updateStudioTrack(
    id: string,
    projectId: string,
    updates: Partial<StudioTrack>
  ): Promise<StudioTrack> {
  ...
  async updateStudioTrackEffects(
    id: string,
    projectId: string,
    effects: unknown
  ): Promise<StudioTrack> {
  ...
  async getProcessedTrackAudio(
    ...
    return this.executeWithCircuitBreaker(async () => {
      ...
      const latestProcessing =
        processingHistory.length > 0 ? processingHistory[processingHistory.length - 1] : null;
  ...
  async createAudioClip(clip: InsertAudioClip): Promise<AudioClip> {
    return this.executeWithCircuitBreaker(async () => {
      const [newClip] = await db.insert(audioClips).values(clip).returning();
      return newClip;
    }, 'createAudioClip');
  }
  ...
  async createMidiClip(clip: InsertMidiClip): Promise<MidiClip> {
    return this.executeWithCircuitBreaker(async () => {
      const [newClip] = await db.insert(midiClips).values(clip).returning();
      return newClip;
    }, 'createMidiClip');
  }
  ...
  async createVirtualInstrument(instrument: InsertVirtualInstrument): Promise<VirtualInstrument> {
    return this.executeWithCircuitBreaker(async () => {
      const [newInstrument] = await db.insert(virtualInstruments).values(instrument).returning();
      return newInstrument;
    }, 'createVirtualInstrument');
  }

  async updateVirtualInstrument(
    id: string,
    trackId: string,
    updates: Partial<VirtualInstrument>
  ): Promise<VirtualInstrument> {
  ...
  async deleteVirtualInstrument(id: string, trackId: string): Promise<void> {
    return this.executeWithCircuitBreaker(async () => {
      await db
        ...
        .where(
          sql`${virtualInstruments.id} = ${id} AND ${virtualInstruments.trackId} = ${trackId}`
        );
  ...
  async createAudioEffect(effect: InsertAudioEffect): Promise<AudioEffect> {
    return this.executeWithCircuitBreaker(async () => {
      const [newEffect] = await db.insert(audioEffects).values(effect).returning();
      return newEffect;
    }, 'createAudioEffect');
  }
  ...
  async deleteAudioEffect(id: string): Promise<void> {
    return this.executeWithCircuitBreaker(async () => {
      await db.delete(audioEffects).where(eq(audioEffects.id, id));
    }, 'deleteAudioEffect');
  }
  ...
  async createMixBus(bus: InsertMixBus): Promise<MixBus> {
    return this.executeWithCircuitBreaker(async () => {
      const [newBus] = await db.insert(mixBusses).values(bus).returning();
      return newBus;
    }, 'createMixBus');
  }
  ...
  async createAutomationData(automation: InsertAutomationData): Promise<AutomationData> {
    return this.executeWithCircuitBreaker(async () => {
      const [newAutomation] = await db.insert(automationData).values(automation).returning();
  ...
  async getProjectLyrics(projectId: string): Promise<Lyrics | undefined> {
    return this.executeWithCircuitBreaker(async () => {
      const [lyric] = await db.select().from(lyrics).where(eq(lyrics.projectId, projectId));
  ...
  async createLyrics(lyric: InsertLyrics): Promise<Lyrics> {
    return this.executeWithCircuitBreaker(async () => {
      const [newLyrics] = await db.insert(lyrics).values(lyric).returning();
      return newLyrics;
    }, 'createLyrics');
  }
  ...
  async createGeneratedMelody(melody: InsertGeneratedMelody): Promise<GeneratedMelody> {
    return this.executeWithCircuitBreaker(async () => {
      const [newMelody] = await db.insert(generatedMelodies).values(melody).returning();
      return newMelody;
  ...
  async deleteGeneratedMelody(id: string): Promise<void> {
    return this.executeWithCircuitBreaker(async () => {
      await db.delete(generatedMelodies).where(eq(generatedMelodies.id, id));
  ...
  async createDistributionPackage(pkg: InsertDistributionPackage): Promise<DistributionPackage> {
    return this.executeWithCircuitBreaker(async () => {
      const [newPackage] = await db.insert(distributionPackages).values(pkg).returning();
      return newPackage;
  ...
  async deleteDistributionPackage(id: string): Promise<void> {
    return this.executeWithCircuitBreaker(async () => {
      await db.delete(distributionPackages).where(eq(distributionPackages.id, id));
  ...
  async updateDistributionTrack(
    ...
    return this.executeWithCircuitBreaker(async () => {
      const [updatedTrack] = await db
        ...
        .set(updates)
        .where(
          sql`${distributionTracks.id} = ${id} AND ${distributionTracks.packageId} = ${packageId}`
        )
        .returning();
      return updatedTrack;
    }, 'updateDistributionTrack');
  ...
  async createUploadSession(session: InsertUploadSession): Promise<UploadSession> {
    return this.executeWithCircuitBreaker(async () => {
      const [newSession] = await db.insert(uploadSessions).values(session).returning();
      return newSession;
    }, 'createUploadSession');
  }
    ...
    return this.executeWithCircuitBreaker(async () => {
      const query = status
        ? db
            .select()
            .from(uploadSessions)
            .where(and(eq(uploadSessions.userId, userId), eq(uploadSessions.status, status)))
  ...
  // ISRC operations
  async generateISRC(userId: string, trackId: string, metadata: unknown): Promise<string> {
    return this.executeWithCircuitBreaker(async () => {
      ...
      const userYearISRCs = await db
        .select()
        .from(isrcRegistry)
        .where(and(eq(isrcRegistry.userId, userId), eq(isrcRegistry.yearCode, yearCode)))
        .orderBy(desc(isrcRegistry.designation));

      const nextDesignation =
        userYearISRCs.length > 0
  ...
  async getISRC(code: string): Promise<ISRCRegistry | undefined> {
    return this.executeWithCircuitBreaker(async () => {
      const [isrc] = await db.select().from(isrcRegistry).where(eq(isrcRegistry.isrc, code));
  ...
  // UPC operations
  async generateUPC(userId: string, releaseId: string, metadata: unknown): Promise<string> {
    return this.executeWithCircuitBreaker(async () => {
      const crypto = await import('crypto');
  ...
  async getUPC(code: string): Promise<UPCRegistry | undefined> {
    return this.executeWithCircuitBreaker(async () => {
      const [upc] = await db.select().from(upcRegistry).where(eq(upcRegistry.upc, code));
  ...
  async createConversion(conversion: unknown): Promise<any> {
    return this.executeWithCircuitBreaker(async () => {
      const [newConversion] = await db.insert(studioConversions).values(conversion).returning();
  ...
  async deleteConversion(id: string): Promise<void> {
    return this.executeWithCircuitBreaker(async () => {
      await db.delete(studioConversions).where(eq(studioConversions.id, id));
    }, 'deleteConversion');
  }
  ...
  async createAutosave(autosave: InsertAutosave): Promise<Autosave> {
    return this.executeWithCircuitBreaker(async () => {
      const [newAutosave] = await db.insert(autosaves).values(autosave).returning();
      return newAutosave;
    }, 'createAutosave');
  }
  ...
  async getAutosave(id: number): Promise<Autosave | undefined> {
    return this.executeWithCircuitBreaker(async () => {
      const [autosave] = await db.select().from(autosaves).where(eq(autosaves.id, id));
  ...
  async deleteAutosave(id: number): Promise<void> {
    return this.executeWithCircuitBreaker(async () => {
      await db.delete(autosaves).where(eq(autosaves.id, id));
    }, 'deleteAutosave');
  }
  ...
  async saveOrganicMetrics(campaignId: number, organicMetrics: unknown): Promise<void> {
    return this.executeWithCircuitBreaker(async () => {
      await db
        .update(adCampaigns)
        .set({
  ...
  async createAdInsights(insightsData: InsertAdInsights): Promise<AdInsights> {
    return this.executeWithCircuitBreaker(async () => {
      const [newInsights] = await db.insert(adInsights).values(insightsData).returning();
      return newInsights;
    }, 'createAdInsights');
  }

  async updateAdInsights(
    id: string,
    userId: string,
    updates: Partial<InsertAdInsights>
  ): Promise<AdInsights> {
  ...
  async createAdAIRun(run: InsertAdAIRun): Promise<AdAIRun> {
    return this.executeWithCircuitBreaker(async () => {
      const [newRun] = await db.insert(adAIRuns).values(run).returning();
      return newRun;
    }, 'createAdAIRun');
  }
  ...
  async createAdCampaignVariant(variant: InsertAdCampaignVariant): Promise<AdCampaignVariant> {
    return this.executeWithCircuitBreaker(async () => {
      const [newVariant] = await db.insert(adCampaignVariants).values(variant).returning();
      return newVariant;
  ...
  async getUserPlatformAccount(
    userId: string,
    platform: string
  ): Promise<AdPlatformAccount | undefined> {
    return this.executeWithCircuitBreaker(async () => {
      const [account] = await db
        .select()
        .from(adPlatformAccounts)
        .where(
          and(eq(adPlatformAccounts.userId, userId), eq(adPlatformAccounts.platform, platform))
        );
      return account;
  ...
  async createAdDeliveryLog(log: InsertAdDeliveryLog): Promise<AdDeliveryLog> {
    return this.executeWithCircuitBreaker(async () => {
      const [newLog] = await db.insert(adDeliveryLogs).values(log).returning();
      return newLog;
    }, 'createAdDeliveryLog');
  }
  ...
  async getDeliveryLogs(campaignId: number): Promise<AdDeliveryLog[]> {
    return this.executeWithCircuitBreaker(async () => {
      ...
      return await db
        .select()
        .from(adDeliveryLogs)
        .where(or(...variantIds.map((id) => eq(adDeliveryLogs.variantId, id))))
  ...
  async createAdKillRule(rule: InsertAdKillRule): Promise<AdKillRule> {
    return this.executeWithCircuitBreaker(async () => {
      const [newRule] = await db.insert(adKillRules).values(rule).returning();
      return newRule;
    }, 'createAdKillRule');
  }
  ...
  async createAdRuleExecution(execution: InsertAdRuleExecution): Promise<AdRuleExecution> {
    return this.executeWithCircuitBreaker(async () => {
      const [newExecution] = await db.insert(adRuleExecutions).values(execution).returning();
      return newExecution;
  ...
  // Social Amplification Professional Features operations
  async createInfluencerScore(score: unknown): Promise<any> {
    return this.executeWithCircuitBreaker(async () => {
      const [created] = await db.insert(socialInfluencerScores).values(score).returning();
      return created;
  ...
  async getInfluencerScore(userId: string, platform: string): Promise<any | undefined> {
    return this.executeWithCircuitBreaker(async () => {
      const [score] = await db
        ...
        .where(
          and(
            eq(socialInfluencerScores.userId, userId),
            eq(socialInfluencerScores.platform, platform)
          )
        )
  ...
  async updateInfluencerScore(id: string, updates: unknown): Promise<any> {
    return this.executeWithCircuitBreaker(async () => {
      const [updated] = await db
  ...
  async createViralTracking(tracking: unknown): Promise<any> {
    return this.executeWithCircuitBreaker(async () => {
      const [created] = await db.insert(socialViralTracking).values(tracking).returning();
      return created;
    }, 'createViralTracking');
  }
  ...
  async updateViralTracking(id: string, updates: unknown): Promise<any> {
    return this.executeWithCircuitBreaker(async () => {
      const [updated] = await db
  ...
  async createNetworkAnalysis(analysis: unknown): Promise<any> {
    return this.executeWithCircuitBreaker(async () => {
      const [created] = await db.insert(socialNetworkAnalysis).values(analysis).returning();
      return created;
  ...
  async getNetworkAnalysis(userId: string, platform: string): Promise<any | undefined> {
    return this.executeWithCircuitBreaker(async () => {
      const [analysis] = await db
        ...
        .where(
          and(
            eq(socialNetworkAnalysis.userId, userId),
            eq(socialNetworkAnalysis.platform, platform)
          )
        )
  ...
  async updateNetworkAnalysis(id: string, updates: unknown): Promise<any> {
    return this.executeWithCircuitBreaker(async () => {
      const [updated] = await db
  ...
  async getMarketplaceBeats(filters: unknown, sortBy?: string): Promise<any[]> {
    return this.executeWithCircuitBreaker(async () => {
      const conditions: unknown[] = [eq(projects.type, 'beat')];
  ...
  async calculateDynamicPrice(beatId: number): Promise<number> {
    return this.executeWithCircuitBreaker(async () => {
      const [beat] = await db.select().from(projects).where(eq(projects.id, beatId));
  ...
  async getRoyaltyStatements(
    ...
    return this.executeWithCircuitBreaker(async () => {
      ...
      const conditions: unknown[] = [eq(projects.userId, userId)];
  ...
  async getPlatformEarnings(userId: string, period: string): Promise<any[]> {
    return this.executeWithCircuitBreaker(async () => {
      ...
      return [
        ...
        { platform: 'YouTube Music', earnings: 321.0, streams: 9530, growth: 12.5 },
  ...
  async getUserPayouts(userId: string, options: unknown): Promise<any[]> {
    return this.executeWithCircuitBreaker(async () => {
    ...
    return this.executeWithCircuitBreaker(async () => {
      try {
        ...
        const breakdown = await db
          ...
          .where(
            and(
              sql`${revenueEvents.projectId} IN (${sql.join(
        ...
        const totalRevenue = breakdown.reduce(
          (sum, item) => sum + parseFloat(item.totalRevenue.toString()),
          0
        );
        ...
        logger.error('Database getPlatformBreakdown failed:', error);
        return [];
      }
  ...
  async getTopEarningTracks(userId: string, period?: string): Promise<TopEarningTrack[]> {
    return this.executeWithCircuitBreaker(async () => {
      try {
        ...
        logger.error('Database getTopEarningTracks failed:', error);
        return [];
      }
    }, 'getTopEarningTracks');
  }
  ...
  async getRoyaltySplits(userId: string): Promise<any[]> {
    return this.executeWithCircuitBreaker(async () => {
      ...
      const splits = await db
        ...
        .from(royaltySplits)
        .where(
          sql`${royaltySplits.listingId} IN (${sql.join(
  ...
  async createRoyaltySplit(data: unknown): Promise<any> {
    return this.executeWithCircuitBreaker(async () => {
  ...
  async updateRoyaltySplit(id: string, data: unknown): Promise<any> {
    return this.executeWithCircuitBreaker(async () => {
  ...
  async getPaymentMethods(userId: string): Promise<PaymentMethod[]> {
    return this.executeWithCircuitBreaker(async () => {
      try {
        ...
        logger.error('Database getPaymentMethods failed:', error);
        return [];
      }
    }, 'getPaymentMethods');
  }
  ...
  async createPaymentMethod(userId: string, data: InsertPaymentMethod): Promise<PaymentMethod> {
    return this.executeWithCircuitBreaker(async () => {
      try {
        ...
        logger.error('Database createPaymentMethod failed:', error);
        throw error;
      }
    }, 'createPaymentMethod');
  }
  ...
  // Sales operations
  async getUserSales(userId: string, options: unknown): Promise<any[]> {
  ...
  async getDashboardStats(userId: string): Promise<{
    ...
    return this.executeWithCircuitBreaker(async () => {
      ...
      const [activeDistributionsResult] = await db
        ...
        .from(distributionPackages)
        .where(
          and(eq(distributionPackages.userId, userId), eq(distributionPackages.status, 'active'))
        );
      ...
      const [currentMonthTracksResult] = await db
        .select({ count: sql<number>`COUNT(*)` })
        .from(projects)
        .where(and(eq(projects.userId, userId), gte(projects.createdAt, currentMonthStart)));
      ...
      const [currentMonthRevenueResult] = await db
        ...
        .from(revenueEvents)
        .innerJoin(projects, eq(revenueEvents.projectId, projects.id))
        .where(and(eq(projects.userId, userId), gte(revenueEvents.occurredAt, currentMonthStart)));
      ...
      const [currentMonthSocialReachResult] = await db
        ...
        .innerJoin(socialCampaigns, eq(socialMetrics.campaignId, socialCampaigns.id))
        .where(
          and(eq(socialCampaigns.userId, userId), gte(socialMetrics.metricAt, currentMonthStart))
        );
      ...
      const distributionsGrowth =
        previousDistributions > 0
      ...
      const socialReachGrowth =
        previousSocialReach > 0
          ? ((currentSocialReach - previousSocialReach) / previousSocialReach) * 100
          : currentSocialReach > 0
            ? 100
            : 0;
  ...
  > {
    return this.executeWithCircuitBreaker(async () => {
      ...
      const mapStatus = (type: string): 'success' | 'warning' | 'error' | 'info' => {
        ...
        if (type === 'success' || type === 'release_approved' || type === 'payout')
          return 'success';
        return 'info';
      };
  ...
  async getAiInsights(userId: string): Promise<{
    ...
    return this.executeWithCircuitBreaker(async () => {
      ...
      const [currentMonthData] = await db
        ...
        .from(analytics)
        .where(and(eq(analytics.userId, userId), gte(analytics.date, currentMonthStart)));
      ...
      const nextMonthRevenue = Math.max(
        0,
        Math.round(revenueCurrent * (1 + avgRevenueGrowth) * 100) / 100
      );

      const engagementRate =
        streamsCurrent > 0 ? streamsCurrent / Math.max(totalProjectsResult?.count || 1, 1) : 0;
      ...
      if (streamsCurrent < 1000) {
        recommendations.push({
          ...
          description:
            'Your streams are below target. Consider distributing to more platforms and increasing promotional efforts.',
          priority: 'high',
          category: 'growth',
        });
      }
      ...
      if (totalReleasesResult?.count === 0) {
        recommendations.push({
          ...
          description:
            'Start distributing your music to streaming platforms to generate revenue and build your audience.',
          priority: 'high',
      ...
      if (growthTrend === 'down') {
        recommendations.push({
          ...
          description:
            'Your streams are declining. Focus on new releases, playlisting, and social media marketing.',
          priority: 'high',
          category: 'marketing',
        });
      }
      ...
      if (viralPotential > 70) {
        recommendations.push({
          ...
          description:
            'Your content shows high engagement. Invest in TikTok and Instagram marketing to maximize reach.',
          priority: 'medium',
          category: 'marketing',
        });
      }
      ...
      if (totalProjectsResult?.count > 0 && totalReleasesResult?.count === 0) {
        recommendations.push({
          ...
          description:
            'You have projects ready. Distribute them to streaming platforms to start earning revenue.',
          priority: 'medium',
          category: 'distribution',
        });
      }
      ...
      if (recommendations.length === 0) {
        recommendations.push({
          ...
          description:
            'Great work! Keep releasing quality content and engaging with your audience.',
          priority: 'low',
          category: 'general',
        });
      }
      ...
      const hasData =
        streamsCurrent > 0 || revenueCurrent > 0 || (totalProjectsResult?.count || 0) > 0;
      const growthScore = Math.max(0, Math.min(100, (avgStreamsGrowth + 1) * 50));
      const engagementScore = Math.min(100, engagementRate / 10);
      const activityScore = Math.min(
        100,
        ((totalProjectsResult?.count || 0) + (totalReleasesResult?.count || 0)) * 10
      );
  ...
  async updateAdminSetting(key: string, value: unknown) {
  ...
  async getListings(filters?: unknown): Promise<Listing[]> {
    return this.executeWithCircuitBreaker(async () => {
  ...
  async createListing(listing: unknown): Promise<Listing> {
    return this.executeWithCircuitBreaker(async () => {
  ...
  async getBeatListings(filters: {
    ...
    return this.executeWithCircuitBreaker(async () => {
      const conditions: unknown[] = [eq(listings.isPublished, true)];

      // Filter by search term (title and description)
      if (filters.search) {
        const searchTerm = `%${filters.search}%`;
        conditions.push(
          or(like(listings.title, searchTerm), like(listings.description, searchTerm))
        );
      }
      ...
      return dbListings.map((listing: unknown) => {
  ...
  async getOrders(filters?: unknown): Promise<Order[]> {
    return this.executeWithCircuitBreaker(async () => {
  ...
  async createOrder(order: unknown): Promise<Order> {
    return this.executeWithCircuitBreaker(async () => {
  ...
  async getSalesAnalytics(userId: string): Promise<any> {
    return this.executeWithCircuitBreaker(async () => {
      const userOrders = await db.select().from(orders).where(eq(orders.sellerId, userId));

      const totalSales = userOrders.length;
      const totalRevenue =
        userOrders.reduce((sum, order) => sum + (order.amountCents || 0), 0) / 100;
      ...
      const licenseTypes = userOrders.reduce(
        (acc, order) => {
      ...
      const dayStats = userOrders.reduce(
        (acc, order) => {
      ...
      const hourStats = userOrders.reduce(
        (acc, order) => {
  ...
  // Plugin Catalog operations
  async getPluginCatalog(category?: string): Promise<
    Array<{
      id: string;
      slug: string;
      name: string;
  ...
  async seedPluginCatalog(): Promise<void> {
    return this.executeWithCircuitBreaker(async () => {
      ...
      const [existingPlugin] = await db.select().from(pluginCatalog).limit(1);
      ...
      const pluginsToSeed: Array<{
        ...
        // === LEGENDARY EQs ===
        {
          ...
          manifest: {
            description:
              'Ultra-precise 8-band parametric EQ with surgical frequency targeting and phase-linear operation',
        ...
        },
        {
          ...
          manifest: {
            description:
              'Reference-quality linear-phase EQ for transparent mastering-grade adjustments',
            manufacturer: 'Max Booster',
        ...
        },
        {
          ...
          manifest: {
            description:
              'Intelligent dynamic EQ with frequency-dependent compression and adaptive curves',
            manufacturer: 'Max Booster',
        ...
        // === LEGENDARY COMPRESSORS ===
        {
          ...
          manifest: {
            description:
              'Optical compressor with smooth, musical gain reduction and vintage warmth',
            manufacturer: 'Max Booster',
        ...
        },
        {
          ...
          manifest: {
            description:
              'VCA bus compressor with aggressive punch and legendary glue characteristics',
            manufacturer: 'Max Booster',
        ...
        },
        {
          ...
          manifest: {
            description:
              'Tube-based variable-mu compressor with rich harmonic saturation and vintage vibe',
            manufacturer: 'Max Booster',
        ...
        },
        {
          ...
          manifest: {
            description:
              'Ultra-fast FET compressor with explosive transient shaping and punch enhancement',
            manufacturer: 'Max Booster',
        ...
        },
        {
          ...
          manifest: {
            description:
              'Professional 4-band multiband compressor with independent stereo processing',
            manufacturer: 'Max Booster',
        ...
        },
        {
          ...
          manifest: {
            description:
              'Classic transistor overdrive with odd-harmonic edge and aggressive character',
            manufacturer: 'Max Booster',
        ...
        },
        {
          ...
          manifest: {
            description:
              'Legendary console channel saturation with transformer coloration and punch',
            manufacturer: 'Max Booster',
        ...
        },
        {
          ...
          manifest: {
            description:
              'Advanced wavetable synth with morphing capabilities and digital precision',
            manufacturer: 'Max Booster',
        ...
        },
        {
          ...
          manifest: {
            description:
              'Professional FM synthesizer with 8-operator matrix and classic DX algorithms',
            manufacturer: 'Max Booster',
        ...
        },
        {
          ...
          manifest: {
            description:
              'Monophonic bass synth with sub-harmonic generation and earth-shaking power',
            manufacturer: 'Max Booster',
        ...
        // === PITCH CORRECTION & VOCAL ===
        {
          ...
          manifest: {
            description:
              'Professional pitch correction with scale detection and formant preservation',
            manufacturer: 'Max Booster',
        ...
        // === STEREO IMAGING & WIDTH ===
        {
          ...
          manifest: {
            description:
              'Advanced stereo imaging with multi-band width control and mono compatibility',
            manufacturer: 'Max Booster',
        ...
        },
        {
          ...
          manifest: {
            description:
              'Broadcast-standard loudness meter with LUFS, true-peak, and dynamic range',
            manufacturer: 'Max Booster',
        ...
        // === CHANNEL STRIPS & PREAMPS ===
        {
          ...
          manifest: {
            description:
              'Legendary British console channel with EQ, dynamics, and transformer coloration',
            manufacturer: 'Max Booster',
  ...
  async saveTrackAnalysis(analysis: InsertTrackAnalysis): Promise<TrackAnalysis> {
    return this.executeWithCircuitBreaker(async () => {
      const [result] = await db.insert(trackAnalysis).values(analysis).returning();
      return result;
    }, 'saveTrackAnalysis');
  }
  ...
  async createProjectCollaborator(data: InsertProjectCollaborator): Promise<ProjectCollaborator> {
    return this.executeWithCircuitBreaker(async () => {
      const [collaborator] = await db.insert(projectCollaborators).values(data).returning();
      return collaborator;
  ...
  async deleteProjectCollaboratorByProjectAndUser(
    projectId: string,
    userId: string
  ): Promise<void> {
    return this.executeWithCircuitBreaker(async () => {
  ...
  async createCollabSession(session: InsertStudioCollabSession): Promise<StudioCollabSession> {
    return this.executeWithCircuitBreaker(async () => {
      const [result] = await db.insert(studioCollabSessions).values(session).returning();
      return result;
    }, 'createCollabSession');
  }
  ...
  async updateCollabSessionActivity(id: string, awarenessState: unknown): Promise<void> {
    return this.executeWithCircuitBreaker(async () => {
      await db
  ...
  async saveCollabSnapshot(snapshot: InsertStudioCollabSnapshot): Promise<StudioCollabSnapshot> {
    return this.executeWithCircuitBreaker(async () => {
      const [result] = await db.insert(studioCollabSnapshots).values(snapshot).returning();
      return result;
    }, 'saveCollabSnapshot');
  }
  ...
  async deleteOldCollabSnapshots(projectId: string, keepLast: number = 10): Promise<void> {
    return this.executeWithCircuitBreaker(async () => {
      ...
      if (idsToKeep.length > 0) {
        await db.delete(studioCollabSnapshots).where(
          and(
            eq(studioCollabSnapshots.projectId, projectId),
            sql`${studioCollabSnapshots.id} NOT IN (${sql.join(
  ...
  async createProjectRoyaltySplit(data: InsertProjectRoyaltySplit): Promise<ProjectRoyaltySplit> {
    return this.executeWithCircuitBreaker(async () => {
      const [split] = await db.insert(projectRoyaltySplits).values(data).returning();
      return split;
    }, 'createProjectRoyaltySplit');
  }

  async updateProjectRoyaltySplit(
    id: string,
    data: Partial<InsertProjectRoyaltySplit>
  ): Promise<ProjectRoyaltySplit> {
    return this.executeWithCircuitBreaker(async () => {
  ...
  async deleteProjectRoyaltySplit(id: string): Promise<void> {
    return this.executeWithCircuitBreaker(async () => {
      await db.delete(projectRoyaltySplits).where(eq(projectRoyaltySplits.id, id));
  ...
  async createProjectRevenueEvent(data: InsertRevenueEvent): Promise<RevenueEvent> {
    return this.executeWithCircuitBreaker(async () => {
      ...
      return db.transaction(async (tx) => {
        ...
        const [event] = await tx.insert(revenueEvents).values(data).returning();
        ...
        if (ledgerEntries.length > 0) {
          await tx.insert(royaltyLedger).values(ledgerEntries);
        }
  ...
  // Royalty ledger queries
  async getLedgerEntriesByCollaborator(
    collaboratorId: string,
    projectId?: string
  ): Promise<RoyaltyLedger[]> {
    return this.executeWithCircuitBreaker(async () => {
  ...
  async getPendingEarningsForCollaborator(
    collaboratorId: string
  ): Promise<{ total: string; byProject: unknown[] }> {
    return this.executeWithCircuitBreaker(async () => {
      const entries = await db
        ...
        .from(royaltyLedger)
        .where(
          and(eq(royaltyLedger.collaboratorId, collaboratorId), eq(royaltyLedger.isPaid, false))
        );
  ...
  async getTotalEarningsForCollaborator(
    collaboratorId: string
  ): Promise<{ total: string; paid: string; pending: string }> {
    return this.executeWithCircuitBreaker(async () => {
      const entries = await db
  ...
  async createProjectRoyaltyPayment(data: InsertRoyaltyPayment): Promise<RoyaltyPayment> {
    return this.executeWithCircuitBreaker(async () => {
      return db.transaction(async (tx) => {
        ...
        const [payment] = await tx.insert(royaltyPayments).values(data).returning();
  ...
  async getProjectRoyaltyPayments(
    collaboratorId: string,
    limit?: number,
    offset?: number
  ): Promise<{ data: RoyaltyPayment[]; total: number }> {
    return this.executeWithCircuitBreaker(async () => {
      const actualLimit = limit || 50;
      const actualOffset = offset || 0;
  ...
  async updateRoyaltyPaymentStatus(
    id: string,
    status: string,
    stripePaymentId?: string
  ): Promise<RoyaltyPayment> {
  ...
  // Reporting
  async getProjectRoyaltySummary(
    projectId: string
  ): Promise<{ collaborators: unknown[]; totalRevenue: string; splits: unknown[] }> {
    return this.executeWithCircuitBreaker(async () => {
      // Get total revenue
      ...
      return {
        ...
        collaborators: Object.values(collaboratorSummaries).map((c: unknown) => ({
          ...c,
  ...
  async getTrendEvents(limit?: number, source?: string, impact?: string): Promise<TrendEvent[]> {
    return this.executeWithCircuitBreaker(async () => {
      ...
      return query.orderBy(desc(trendEvents.detectedAt)).limit(limit || 100);
    }, 'getTrendEvents');
  }
  ...
  async getUserAssets(
    ...
    return this.executeWithCircuitBreaker(async () => {
      let query = db.select().from(userAssets).where(eq(userAssets.userId, userId));
      ...
      const results = await query.orderBy(desc(userAssets.createdAt)).limit(limit).offset(offset);
  ...
  async getUserAssetById(id: string): Promise<UserAsset | undefined> {
    return this.executeWithCircuitBreaker(async () => {
      const [asset] = await db.select().from(userAssets).where(eq(userAssets.id, id)).limit(1);
      return asset;
    }, 'getUserAssetById');
  }
  ...
  async getAssetFolderById(id: string): Promise<AssetFolder | undefined> {
    return this.executeWithCircuitBreaker(async () => {
      const [folder] = await db.select().from(assetFolders).where(eq(assetFolders.id, id)).limit(1);
      return folder;
    }, 'getAssetFolderById');
  }
  ...
  async addAssetTag(assetId: string, tag: string): Promise<AssetTag> {
    return this.executeWithCircuitBreaker(async () => {
      const [created] = await db.insert(assetTags).values({ assetId, tag }).returning();
      return created;
    }, 'addAssetTag');
  }
  ...
  async getAssetTags(assetId: string): Promise<AssetTag[]> {
    return this.executeWithCircuitBreaker(async () => {
      return await db.select().from(assetTags).where(eq(assetTags.assetId, assetId));
    }, 'getAssetTags');
  }
  ...
  async getWebhookAttempt(id: string): Promise<WebhookAttempt | undefined> {
    return this.executeWithCircuitBreaker(async () => {
      const [attempt] = await db.select().from(webhookAttempts).where(eq(webhookAttempts.id, id));
      return attempt;
    }, 'getWebhookAttempt');
  }
  ...
  async getTaxProfile(userId: string): Promise<CollaboratorTaxProfile | undefined> {
    return this.executeWithCircuitBreaker(async () => {
      const result = await db
        .select()
        .from(collaboratorTaxProfiles)
        .where(eq(collaboratorTaxProfiles.userId, userId))
        .limit(1);
      return result[0];
    }, 'getTaxProfile');
  }
  ...
  async updateTaxProfile(
    id: number,
    updates: Partial<InsertCollaboratorTaxProfile>
  ): Promise<CollaboratorTaxProfile> {
    return this.executeWithCircuitBreaker(async () => {
      const [result] = await db
        .update(collaboratorTaxProfiles)
        .set({ ...updates, updatedAt: new Date() })
        .where(eq(collaboratorTaxProfiles.id, id))
        .returning();
      return result;
    }, 'updateTaxProfile');
  }

  async getCollaboratorsForTaxYear(
    year: number
  ): Promise<{ userId: string; totalEarnings: number }[]> {
    return this.executeWithCircuitBreaker(async () => {
      ...
      const results = await db
        ...
        .where(
          and(gte(revenueEvents.occurredAt, startDate), lte(revenueEvents.occurredAt, endDate))
        )
  ...
  async getImportHistory(userId: string): Promise<RevenueImportHistory[]> {
    return this.executeWithCircuitBreaker(async () => {
      return await db
        .select()
        .from(revenueImportHistory)
        .where(eq(revenueImportHistory.userId, userId))
        .orderBy(desc(revenueImportHistory.uploadedAt));
    }, 'getImportHistory');
  }
  ...
  async checkFileHash(hash: string): Promise<RevenueImportHistory | undefined> {
    return this.executeWithCircuitBreaker(async () => {
      const result = await db
        .select()
        .from(revenueImportHistory)
        .where(eq(revenueImportHistory.fileHash, hash))
        .limit(1);
      return result[0];
    }, 'checkFileHash');
  }

  async ingestRevenueBatch(
    events: InsertRevenueEvent[]
  ...
  async lockRoyaltySplit(splitId: string): Promise<void> {
    return this.executeWithCircuitBreaker(async () => {
      await db
        ...
        .where(eq(projectRoyaltySplits.id, splitId));
    }, 'lockRoyaltySplit');
  }
  ...
  async getForecastsByProject(projectId: string, limit = 10): Promise<ForecastSnapshot[]> {
    return this.executeWithCircuitBreaker(async () => {
      return await db
        ...
        .where(eq(forecastSnapshots.projectId, projectId))
  ...
  async getDistroRelease(id: string): Promise<DistroRelease | undefined> {
    return this.executeWithCircuitBreaker(async () => {
      const [release] = await db.select().from(distroReleases).where(eq(distroReleases.id, id));
      return release;
    }, 'getDistroRelease');
  }
  ...
  async updateDistroRelease(
    id: string,
    data: Partial<InsertDistroRelease>
  ...
  async validateISRCCode(isrc: string): Promise<boolean> {
    return this.executeWithCircuitBreaker(async () => {
      const [existing] = await db.select().from(isrcRegistry).where(eq(isrcRegistry.isrc, isrc));
  ...
  async validateUPCCode(upc: string): Promise<boolean> {
    return this.executeWithCircuitBreaker(async () => {
      const [existing] = await db.select().from(upcRegistry).where(eq(upcRegistry.upc, upc));
      return !existing; // Returns true if code is available (not found)
    }, 'validateUPCCode');
  }
    ...
    return this.executeWithCircuitBreaker(async () => {
      ...
      for (const provider of providers) {
        try {
          ...
          logger.error(`Failed to insert provider ${provider.name}:`, error);
        }
      }
    }, 'seedDSPProviders');
  }
  ...
  async listModelVersions(modelId: string, status?: string): Promise<AIModelVersion[]> {
    return databaseResilience.executeWithRetry(async () => {
      ...
      if (status) {
        query = query.where(
          and(eq(aiModelVersions.modelId, modelId), eq(aiModelVersions.status, status))
        ) as any;
      }
  ...
  async listTrainingDatasets(filters?: {
    datasetType?: string;
    isActive?: boolean;
  }): Promise<TrainingDataset[]> {
    return databaseResilience.executeWithRetry(async () => {
      ...
      if (filters?.datasetType)
        conditions.push(eq(trainingDatasets.datasetType, filters.datasetType));
      if (filters?.isActive !== undefined)
        conditions.push(eq(trainingDatasets.isActive, filters.isActive));
  ...
  async getPerformanceMetrics(filters?: {
    ...
    return databaseResilience.executeWithRetry(async () => {
      ...
      if (filters?.startDate)
        conditions.push(gte(performanceMetrics.measuredAt, filters.startDate));
  ...
  async createRetrainingSchedule(
    schedule: InsertAIRetrainingSchedule
  ): Promise<AIRetrainingSchedule> {
    return databaseResilience.executeWithRetry(async () => {
  ...
  async listComplianceControls(filters?: {
    standard?: string;
    status?: string;
    category?: string;
  }): Promise<ComplianceControl[]> {
  ...
  async listComplianceEvidence(filters?: {
    controlId?: string;
    evidenceType?: string;
    automated?: boolean;
  }): Promise<ComplianceEvidence[]> {
  ...
  async getComplianceAuditByAuditId(auditId: string): Promise<ComplianceAudit | undefined> {
    return databaseResilience.executeWithRetry(async () => {
      const [audit] = await db
        ...
        .where(eq(complianceAudits.auditId, auditId));
      return audit;
    }, 'getComplianceAuditByAuditId');
  }

  async listComplianceAudits(filters?: {
    standard?: string;
    status?: string;
    startDate?: Date;
    endDate?: Date;
