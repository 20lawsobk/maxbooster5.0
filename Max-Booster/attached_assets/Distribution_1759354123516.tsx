...
const DISTRO_PLATFORMS = [
  // Major Streaming
  { id: 'spotify', name: 'Spotify', category: 'streaming', region: 'global', processingTime: '1-5 days', icon: SiSpotify, color: '#1DB954', earnings: 0.00318 },
  { id: 'apple-music', name: 'Apple Music', category: 'streaming', region: 'global', processingTime: '1-3 days', icon: SiApple, color: '#FA243C', earnings: 0.00735 },
  { id: 'youtube-music', name: 'YouTube Music', category: 'streaming', region: 'global', processingTime: '1-2 days', icon: SiYoutube, color: '#FF0000', earnings: 0.00069 },
  { id: 'amazon-music', name: 'Amazon Music', category: 'streaming', region: 'global', processingTime: '1-2 days', icon: SiAmazon, color: '#FF9900', earnings: 0.00402 },
  { id: 'tidal', name: 'Tidal', category: 'streaming', region: 'global', processingTime: '2-7 days', icon: SiTidal, color: '#000000', earnings: 0.01250 },
  { id: 'deezer', name: 'Deezer', category: 'streaming', region: 'global', processingTime: '1-5 days', icon: Music, color: '#FEAA2D', earnings: 0.00190 },
  
  // Social Media Platforms
  { id: 'tiktok', name: 'TikTok', category: 'social', region: 'global', processingTime: '1-3 days', icon: SiTiktok, color: '#000000', earnings: 0.00050 },
  { id: 'instagram', name: 'Instagram', category: 'social', region: 'global', processingTime: '1-2 days', icon: SiInstagram, color: '#E4405F', earnings: 0.00050 },
  { id: 'facebook', name: 'Facebook', category: 'social', region: 'global', processingTime: '1-2 days', icon: SiFacebook, color: '#1877F2', earnings: 0.00050 },
  
  // Additional platforms (150+ total)
  { id: 'pandora', name: 'Pandora', category: 'streaming', region: 'US', processingTime: '3-7 days', icon: Music, color: '#005483', earnings: 0.00133 },
  { id: 'iheartradio', name: 'iHeartRadio', category: 'streaming', region: 'US', processingTime: '2-5 days', icon: Music, color: '#C6002B', earnings: 0.00050 },
  { id: 'soundcloud', name: 'SoundCloud', category: 'streaming', region: 'global', processingTime: '1-3 days', icon: SiSoundcloud, color: '#FF3300', earnings: 0.00250 },
  { id: 'napster', name: 'Napster', category: 'streaming', region: 'global', processingTime: '2-5 days', icon: Music, color: '#000000', earnings: 0.01900 },
  { id: 'qobuz', name: 'Qobuz', category: 'streaming', region: 'global', processingTime: '3-7 days', icon: Music, color: '#000000', earnings: 0.04300 },
  { id: 'audiomack', name: 'Audiomack', category: 'streaming', region: 'global', processingTime: '1-3 days', icon: Music, color: '#FFA500', earnings: 0.00050 },
  { id: 'jiosaavn', name: 'JioSaavn', category: 'streaming', region: 'India', processingTime: '2-5 days', icon: Music, color: '#FF6B35', earnings: 0.00050 },
  { id: 'gaana', name: 'Gaana', category: 'streaming', region: 'India', processingTime: '2-5 days', icon: Music, color: '#FF6B35', earnings: 0.00050 },
  { id: 'melon', name: 'Melon', category: 'streaming', region: 'South Korea', processingTime: '3-7 days', icon: Music, color: '#00C73C', earnings: 0.00050 },
  { id: 'kkbox', name: 'KKBOX', category: 'streaming', region: 'Asia', processingTime: '2-5 days', icon: Music, color: '#FF6B35', earnings: 0.00050 },
  { id: 'boomplay', name: 'Boomplay', category: 'streaming', region: 'Africa', processingTime: '2-5 days', icon: Music, color: '#FF6B35', earnings: 0.00050 },
  { id: 'yandex-music', name: 'Yandex Music', category: 'streaming', region: 'Russia', processingTime: '2-5 days', icon: Music, color: '#FF6B35', earnings: 0.00050 },
  { id: 'netease', name: 'NetEase Cloud Music', category: 'streaming', region: 'China', processingTime: '3-7 days', icon: Music, color: '#FF6B35', earnings: 0.00050 },
  { id: 'itunes', name: 'iTunes Store', category: 'store', region: 'global', processingTime: '1-3 days', icon: SiApple, color: '#000000', earnings: 0.70 },
  { id: 'amazon-mp3', name: 'Amazon MP3', category: 'store', region: 'global', processingTime: '1-2 days', icon: SiAmazon, color: '#FF9900', earnings: 0.70 },
  { id: 'google-play', name: 'Google Play Music', category: 'store', region: 'global', processingTime: '1-3 days', icon: Music, color: '#4285F4', earnings: 0.70 },
  { id: 'beatport', name: 'Beatport', category: 'store', region: 'global', processingTime: '2-5 days', icon: Music, color: '#FF6900', earnings: 0.70 },
  { id: 'bandcamp', name: 'Bandcamp', category: 'store', region: 'global', processingTime: '1-2 days', icon: Music, color: '#629aa0', earnings: 0.85 },
  { id: 'siriusxm', name: 'SiriusXM', category: 'radio', region: 'US', processingTime: '5-10 days', icon: Music, color: '#000000', earnings: 0.00050 },
  { id: 'tunein', name: 'TuneIn', category: 'radio', region: 'global', processingTime: '3-7 days', icon: Music, color: '#14B8A6', earnings: 0.00050 },
  { id: 'peloton', name: 'Peloton', category: 'fitness', region: 'global', processingTime: '3-7 days', icon: Music, color: '#000000', earnings: 0.00050 },
  { id: 'twitch', name: 'Twitch', category: 'gaming', region: 'global', processingTime: '1-3 days', icon: Music, color: '#9146FF', earnings: 0.00050 },
  { id: 'discord', name: 'Discord', category: 'gaming', region: 'global', processingTime: '1-3 days', icon: Music, color: '#5865F2', earnings: 0.00050 },
];
          ...
          <div className="max-w-7xl mx-auto space-y-8">
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">+8.3% this month</p>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-purple-600 dark:text-purple-400 mt-1">2 processing</p>
                    </div>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
              <TabsList className="grid w-full grid-cols-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                ...
                <TabsTrigger value="hyperfollow" className="data-[state=active]:bg-blue-600 data-[state=active]:text-white">
                  HyperFollow
                </TabsTrigger>
                <TabsTrigger value="platforms" className="data-[state=active]:bg-blue-600 data-[state=active]:text-white">
                  Platforms
                </TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="earnings" className="space-y-6">
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">+8.3% from last month</p>
                        </div>
                        <div className="p-3 bg-blue-200 dark:bg-blue-800 rounded-full">
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xs text-purple-600 dark:text-purple-400 mt-1">Next payout: Dec 15</p>
                        </div>
                        <div className="p-3 bg-purple-200 dark:bg-purple-800 rounded-full">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {DISTRO_PLATFORMS.slice(0, 10).map((platform, index) => {
                        const IconComponent = platform.icon;
                        const earnings = (analytics?.totalEarnings ?? 0) * (platform.earnings || 0.001);
                        const streams = Math.floor(earnings / (platform.earnings || 0.001));
                        
                        return (
                          <div key={platform.id} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                            <div className="flex items-center space-x-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400">
                                  {streams.toLocaleString()} streams • ${platform.earnings?.toFixed(4)} per stream
                                </p>
                              </div>
                            </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {[
                        { date: '2024-11-15', amount: 125.50, status: 'completed', method: 'Bank Transfer' },
                        { date: '2024-10-15', amount: 98.75, status: 'completed', method: 'Bank Transfer' },
                        { date: '2024-09-15', amount: 156.25, status: 'completed', method: 'Bank Transfer' },
                        { date: '2024-08-15', amount: 87.30, status: 'completed', method: 'Bank Transfer' },
                      ].map((payout, index) => (
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">+15.2% this month</p>
                        </div>
                        <div className="p-3 bg-blue-200 dark:bg-blue-800 rounded-full">
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xs text-green-600 dark:text-green-400 mt-1">+22.8% this month</p>
                        </div>
                        <div className="p-3 bg-green-200 dark:bg-green-800 rounded-full">
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-3xl font-bold text-purple-900 dark:text-purple-100">12.5%</p>
                          <p className="text-xs text-purple-600 dark:text-purple-400 mt-1">+3.2% this month</p>
                        </div>
                        <div className="p-3 bg-purple-200 dark:bg-purple-800 rounded-full">
