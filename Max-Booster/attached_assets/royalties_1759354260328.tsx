...
export default function Royalties() {
  ...
  const totalEarnings =
    royalties?.reduce((sum: number, royalty: Royalty) => sum + royalty.amount, 0) || 0;
  ...
  const totalStreams =
    royalities?.reduce((sum: number, royalty: Royalty) => sum + royalty.streams, 0) || 0;
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  $
                  {pendingPayouts
                    .reduce((sum: number, p: Royalty) => sum + p.amount, 0)
                    .toLocaleString()}
                </p>
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    ...
                    { title: 'Neon Nights', earnings: 1156, streams: '289K', rpm: 4.0 },
                    { title: 'Summer Vibes', earnings: 936, streams: '234K', rpm: 4.0 },
                    { title: 'Urban Flow', earnings: 792, streams: '198K', rpm: 4.0 },
                  ].map((track, index) => (
                    <div
                      key={index}
                      className="flex items-center justify-between p-3 bg-muted/20 rounded"
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="p-4 bg-muted/20 rounded-lg">
                    ...
                    <Button data-testid="button-update-tax-info">Update Tax Information</Button>
                  </div>
                </div>
              </div>
            </CardContent>
